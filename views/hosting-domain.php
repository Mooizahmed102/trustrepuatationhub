...
<h2 class="section-head">Growing Your Followers Is No <span>Longer A Dream </span></h2>
</div>
</div>
</div>
</div>
</section>
<section id="host1" class="banner-section bottom-section">
<div class="container">
<div class="row flexRow">
<div class="col-md-6 col-sm-6 col-xs-12">
<div class=" ml-2 wow fadeInLeft" data-wow-delay="0.6s" data-wow-duration="2s">
<h2 class="section-head">Hosting</h2>
<p>Regardless of your business, it is inevitable to occupy space on the server somewhere. Web hosting stores the website's content, making it viewable to visitors and customers. For smaller and beginner-level websites, it is appropriate to use shared hosting. On the other hand, dedicated hosting or VPS is for those who like to have more control.</p>
</div>
</div>
<div class="col-md-6 col-sm-6 col-xs-12">
<div class="banner-img">
...
<section id="host2" class="banner-section bottom-section">
<div class="container">
<div class="row flexRow">
<div class="col-md-6 col-sm-6 col-xs-12">
<div class="banner-img">
...
<h2 class="section-head">Domain</h2>
<p>It all comes down to having the perfect domain services that ensure your website gets the best responses, attracts visitors, and brands your business. Trust Reputation Hub can give you the best solution as far as domain name availability is concerned.</p>
</div>
</div>
</div>
</div>
</section>
<section id="host3" class="banner-section bottom-section">
<div class="container">
<div class="row flexRow">
<div class="col-md-6 col-sm-6 col-xs-12">
<div class=" ml-2 wow fadeInLeft" data-wow-delay="0.6s" data-wow-duration="2s">
<h2 class="section-head">Business <span>Emails</span></h2>
<p>We ensure service uptime scalability and high resilience business email services. Our suite of product features helps employees and organizations streamline activities related to business and improve their productivity.</p>
</div>
</div>
<div class="col-md-6 col-sm-6 col-xs-12">
<div class="banner-img">
...
Brand Stories With Visual Narratives
</h2>
</div>
...
<li class="active"><a data-toggle="pill" href="#home">DATA SAFETY</a></li>
<li><a data-toggle="pill" href="#menu1">ADDED SECURITY</a></li>
<li><a data-toggle="pill" href="#menu2">PROFESSIONAL EMAILS</a></li>
<li><a data-toggle="pill" href="#menu3">AUTOMATED BACK-UPS</a></li>
<li><a data-toggle="pill" href="#menu4">SEO TOOLS</a></li>
</ul>
</div>
...
<div class="tab-content">
<div class="tab-pane fade in active" id="men4">
<div class="row">
...
<div class="scroll-wrapper scroll-wrapper-1">
<ul class="pkg-list">
<li><i class="fa fa-check" aria-hidden="true"></i>Unlimited Website</li>
<li> <i class="fa fa-check" aria-hidden="true"></i>SSL Certificate </li>
...
<ul class="pkg-list">
<li> <i class="fa fa-check" aria-hidden="true"></i>Domain for 05 year</li>
